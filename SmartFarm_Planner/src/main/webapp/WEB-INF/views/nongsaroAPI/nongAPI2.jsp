...
<head>
	...
	<script type="text/javascript">
		...
		nongsaroOpenApiRequest.serviceName = "farmWorkingPlan";//서비스명
		nongsaroOpenApiRequest.operationName = "workScheduleGrpList";//오퍼레이션명 - nongsaroApiLoadingArea 영역에 로딩할 오퍼레이션 
...
<body>
	...
	<section id="main-content">
		<section class="wrapper">
			...
			<div id="nongsaroApiLoadingArea1"></div><!-- 농작업일정 HTML 로딩 영역 -->
		</section>
	</section>
</body>
</html>