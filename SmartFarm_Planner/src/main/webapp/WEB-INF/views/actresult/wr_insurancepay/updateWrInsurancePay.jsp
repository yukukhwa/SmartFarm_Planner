...
<head>
	...
	<title>updateWrInsurancePay</title>
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">
						<i class="fa fa-table"></i>보험비결과 수정화면
					</h3>
				</div>
			</div>
			<!-- page start-->
				...
				<div class="col-lg-12">
					<section class="panel">
						<div class="panel-body">
							<form name="updateWrInsurancePayForm" action="${pageContext.request.contextPath }/updateWrInsurancePay" method="post">
