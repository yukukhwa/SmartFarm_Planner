		...
		<div class="row">
			<div class="col-lg-12">
				...
				<form action="${pageContext.request.contextPath }/addWrEtcSpendPay" method="post">					
					<div><label>작업단계결과 넘버<input type="text" name="wrNumber" value=""></label></div>
					<div><label>예상 기타지출비용 넘버<input type="text" name="eEtcspendpayNumber" value=""></label></div>
					<div><label>작업단계결과별 실제 기타지출비<input type="text" name="wrEtcspendpayRealcost" ></label></div>
					<div><label>작업단계별 기타지출비 등록일<input type="datetime-local" name="wrEtcspendpayDate" ></label></div>
