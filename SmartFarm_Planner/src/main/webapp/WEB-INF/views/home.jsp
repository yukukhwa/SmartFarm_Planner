					...
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-cubes"></i><a
								href="${pageContext.request.contextPath}/listCategoryDeal">거래처</a></li>
							<li><i class="icon_genius"></i><a
								href="${pageContext.request.contextPath}/listCategoryEquip">농기계·장비</a></li>
							<li><i class="icon_table"></i><a
								href="${pageContext.request.contextPath}/listIndustry">산업별</a></li>
							<li><i class="fa fa-flag-o red"></i><a
								href="${pageContext.request.contextPath}/listTheme">테마별</a></li>
						</ol>
					</div>
				</div>
						...
						<section class="panel panel-default">
							...
							<div id="c-slide" class="carousel slide auto panel-body">
								...
								<div class="carousel-inner">
									<div class="item active">
										...
										<ol>
											...
											<li>비교분석 > my 실행결과 리스트에서 확인가능</li>
										</ol>
										<p></p>
										<div class="col-lg-12 text-center">
											<span> <img src="img/slide1.jpg"
												style="width: 33%; height: auto;">
											</span> <span> <img src="img/slide3.jpg"
												style="width: 33%; height: auto;">
											</span> <span> <img src="img/slide2.jpg"
												style="width: 33%; height: auto;">
											</span>
										</div>
									</div>
									...
									<div class="item">
										...
										<p></p>
										<div class="col-lg-12 text-center">
											<span> <img src="img/compa1.jpg"
												style="width: 33%; height: auto;">
											</span> <span> <img src="img/compa2.jpg"
												style="width: 33%; height: auto;">
											</span> <span> <img src="img/compa3.jpg"
												style="width: 33%; height: auto;">
											</span>
										</div>
									</div>
									...
									<div class="item">
										...
										<ol>
											...
											<li>가능한 카테고리 : 거래처 / 장비종류 / 산업분류 / 품목분류 / 테마 / 기타비용 /
												대여장비 / 계획명</li>
										...
										<p></p>
										<div class="col-lg-12 text-center">
											<span> <img src="img/agen1.jpg"
												style="width: 33%; height: auto;">
											</span> <span> <img src="img/agen2.jpg"
												style="width: 33%; height: auto;">
											</span> <span> <img src="img/agen3.jpg"
												style="width: 33%; height: auto;">
											</span>
										</div>
									</div>
								...
								<a data-slide="prev" href="#c-slide"
									...
									class="arrow_carrot-left_alt2"></i>
				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-9">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-flag-o red"></i><strong>대여장비 현황</strong>
								</h2>
								<div class="panel-actions">
									<a href="${pageContext.request.contextPath }/home"
										class="btn-setting"><i class="fa fa-rotate-right"></i></a> <a
